...
app = FastAPI()
app.include_router(auth_router, prefix="/api/v11", tags=["Authentication"])
app.include_router(users_router, prefix="/api/v11", tags=["Users"])
app.include_router(books_router, prefix="/api/v11", tags=["Books"])
